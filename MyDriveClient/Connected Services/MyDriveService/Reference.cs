...
namespace MyDriveClient.MyDriveService {
    ...
    public interface IStorrageService {
        ...
        MyDriveClient.MyDriveService.AnswerResponse Search(string path);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStorrageService/Search", ReplyAction="http://tempuri.org/IStorrageService/SearchResponse")]
        System.Threading.Tasks.Task<MyDriveClient.MyDriveService.AnswerResponse> SearchAsync(string path);
        ...
        MyDriveClient.MyDriveService.AnswerResponse OpenFolder(string path);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStorrageService/OpenFolder", ReplyAction="http://tempuri.org/IStorrageService/OpenFolderResponse")]
        System.Threading.Tasks.Task<MyDriveClient.MyDriveService.AnswerResponse> OpenFolderAsync(string path);
    }
    ...
    public partial class StorrageServiceClient : System.ServiceModel.ClientBase<MyDriveClient.MyDriveService.IStorrageService>, MyDriveClient.MyDriveService.IStorrageService {
        ...
        public MyDriveClient.MyDriveService.AnswerResponse Search(string path) {
            return base.Channel.Search(path);
        }
        
        public System.Threading.Tasks.Task<MyDriveClient.MyDriveService.AnswerResponse> SearchAsync(string path) {
            return base.Channel.SearchAsync(path);
        }
        
        public MyDriveClient.MyDriveService.AnswerResponse OpenFolder(string path) {
            return base.Channel.OpenFolder(path);
        }
        
        public System.Threading.Tasks.Task<MyDriveClient.MyDriveService.AnswerResponse> OpenFolderAsync(string path) {
